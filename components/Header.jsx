    ...
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      <div className="flex flex-col col-span-3 mx-auto">
        ...
        <div className="flex items-center border-b mb-4">
          ...
          <input type='number' className="w-12 pl-2 text-lg outline-none text-red-400" value={numberOfGuests} onChange={e => setNumberOfGuests(e.target.value)} min={1}/>
        </div>
        <div className="flex">
          <button className="flex-grow tet-gray-500" onClick={resetInput}>Cancel</button>
